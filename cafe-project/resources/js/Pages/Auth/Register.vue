  ...
  <div class="min-h-screen flex items-center justify-center px-margin-mobile py-12 bg-surface-container-low">
    <div class="w-full max-w-md">
      ...
      <div class="bg-surface rounded-2xl shadow-soft border border-outline-variant/20 p-8">
        ...
        <a href="/auth/google" class="w-full flex items-center justify-center gap-3 py-3 px-4 bg-surface-container-low hover:bg-surface-container border border-outline-variant/30 rounded-xl font-sans text-label-md text-on-surface transition-all duration-300 hover:shadow-sm">
