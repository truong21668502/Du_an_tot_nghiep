        ...
        <div class="p-6 max-w-6xl mx-auto space-y-6 font-sans">
            ...
            <div class="flex flex-col gap-3">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-label-large text-on-surface-variant">Sửa phiếu #{{ receipt.id }}</span>
                </div>

                <div class="flex items-center gap-3.5">
                    <div
                        class="w-12 h-12 rounded-2xl bg-gradient-to-br from-tertiary to-tertiary/70 flex items-center justify-center shadow-md shadow-tertiary/20 shrink-0">
                        <span class="material-symbols-outlined text-on-tertiary text-[24px]">edit</span>
                    </div>
                    <div>
                        <h1 class="text-headline-md font-bold text-on-surface text-2xl leading-tight tracking-tight">
                            Sửa phiếu nhập #{{ receipt.id }}
                        </h1>
                        <p class="text-body-small text-on-surface-variant mt-0.5">
                            Cập nhật thông tin và nguyên liệu của phiếu nhập đã tạo
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                class="bg-tertiary-container/40 border border-tertiary/30 text-on-tertiary-container text-body-medium rounded-2xl p-4 flex items-start gap-3">
                <span class="w-8 h-8 rounded-full bg-tertiary/15 flex items-center justify-center shrink-0">
                                        ...
                                        <div class="flex-1 min-w-0 space-y-1.5">
                                            ...
                                            <div v-if="getMaterial(item.material_id)"
                                                ...
                                                <p
                                                    ...
                                                    <span
                                                        class="material-symbols-outlined text-tertiary text-[15px]">restart_alt</span>
                                                    Tồn (sau khi hoàn phiếu cũ):
                                                ...
                                                <p v-if="stockAfter(item)"
                                                    class="text-body-small text-primary font-bold flex items-center gap-1">
                                                    <span
