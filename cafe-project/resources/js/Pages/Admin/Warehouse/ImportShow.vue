    ...
    <AdminLayout :title="`Chi Tiết Phiếu Nhập #${receipt.id}`">
        <div class="p-6 max-w-5xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-xl font-bold text-gray-800 text-primary text-3xl"><span class="material-symbols-outlined text-primary">receipt_long</span> PHIẾU NHẬP #{{ receipt.id }}</h1>
            </div>
