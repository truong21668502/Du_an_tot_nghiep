...
class MaterialSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $materials = [
            ...
            [
                'id'                => 1,
                'material_name'     => 'Cà phê phin (Đã pha)',
                'base_unit'         => 'ml',
                'quantity_in_stock' => 20000.00, // 20 Lít nước cốt phin
                'input_unit'        => 'Kg',     // Nhập dạng bột thô
                'exchange_rate'     => 20000.00, // 1 Kg thô pha được 20.000ml cốt
            ],
            [
                'id'                => 2,
                'material_name'     => 'Espresso (Cốt chiết xuất)',
                'base_unit'         => 'ml',
                'quantity_in_stock' => 15000.00, // 15 Lít cốt Espresso
                'input_unit'        => 'Kg',     // Nhập hạt máy
                'exchange_rate'     => 15000.00, // 1 Kg hạt máy chiết được 15.000ml
            ],
